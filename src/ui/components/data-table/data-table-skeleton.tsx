...
export function DataTableSkeleton(props: DataTableSkeletonProps) {
  ...
  const getGridColumns = () => {
    if (is2xl) return cardColumns["2xl"];
    if (isXl) return cardColumns.xl;
    if (isLg) return cardColumns.lg;
    if (isMd) return cardColumns.md;
    if (isSm) return cardColumns.sm;
    return cardColumns.xs;
  };
    ...
    >
      ...
      {withPagination ? (
        <div className="flex w-full items-center justify-between gap-4 overflow-auto p-1 sm:gap-8">
          ...
          <div className="flex items-center gap-4 sm:gap-4 lg:gap-8">
